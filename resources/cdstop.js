...
function resetcanvas() {
    ...
    drawingCanvas.width= $(window).width();
    setInterval(function(){requestAnimationFrame(loop)}, 10);
}
...
function Signal(start) {
    ...
    var tint = (signalCount % 8) * 10;
    // var tint = Math.floor(Math.random() * 360);
    //console.log(tint);
    //this.style = 'hsl(' + tint + ',80%,80%)';
    this.style = 'hsl(' + tint + ',41%,79%)';
